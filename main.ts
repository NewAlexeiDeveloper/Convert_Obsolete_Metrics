...
const metric_select = (document.getElementById('metric_select') as HTMLSelectElement),
    input = document.querySelector('.input') as HTMLInputElement,
    add_row_btn = document.getElementById('add_row')!,
    delete_btn = document.getElementById('delete_0');
...
// function to convert 
function convert(this: any): void {
    const pointer = this.dataset.point

    const to_be_converted = (document.querySelector(`.to_be_converted_${pointer}`) as HTMLSelectElement).value
    const convert_to = (document.querySelector(`.convert_to_${pointer}`) as HTMLSelectElement).value
    const result = document.getElementById(`result_${pointer}`) as HTMLInputElement
    ...
    if (+this.value <= 0) {
        ...
        const html = document.documentElement,
            ...
            needed_coordinate = scroll_top + client_height - 80,
...
add_row_btn.addEventListener('click', () => {
    ...
    if (required_value == 'weight') {
     ...
     `
        ...
        const current_convert_to = document.querySelector(`.to_be_converted_${count}`) as HTMLSelectElement
...
// MOBILE
const metric_select_mobile = document.querySelector('.metric_select_mobile') as HTMLSelectElement,
    to_be_converted_mobile = document.querySelector('.to_be_converted_mobile'),
    convert_to_mobile = document.querySelector('.convert_to_mobile'),
    input_mobile = document.querySelector('#input_mobile') as HTMLInputElement,
    mobile_result = document.querySelector('#mobile_result') as HTMLInputElement,
    copy_mobile = document.querySelector('.copy_mobile')
